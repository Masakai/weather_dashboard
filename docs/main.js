...
import * as uiUtils from './ui-utils.js?v=3.2.0';
import * as locationService from './location-service.js?v=3.2.0';
import * as weatherService from './weather-service.js?v=3.2.0';
import * as issService from './iss-service.js?v=3.2.0';
import * as astronomyService from './astronomy-service.js?v=3.2.0';
